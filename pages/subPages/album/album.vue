			...
			<scroll-view scroll-y="true" class="page-content" >
				<view class="album-top">
									...
									<view class="flex-box">
										...
										<view class="info-con flex-item">
											...
											<view class="avator-box flex-box">
												<image v-if="album.creator" class="avator"
												 :src="album.creator.avatarUrl" mode="widthFix"></image>
							...
							<view class="album-list">
								...
								<!-- 音乐列表 -->
								<view class="list">
									<view class="item flex-box" v-for="(item, index) in album.tracks" 
									:key="index" @click="setPlayList">
