<template>
	<view class="ad-page" @click="close">
			<!-- logo页 -->
			<view class="logo-bg">
				<image class="top-logo" src="../../static/ad/1.png" mode="widthFix"></image>
				<image class="bot-logo" src="../../static/ad/2.png" mode="widthFix"></image>
			</view>
			<!-- 广告页 -->
			<view class="ad-bg" :class="{active: isShowAd}">
				<image class="ad" :src="picture" mode="aspectFill"></image>
				<view class="ad-logo">
					<image class="img" src="../../static/ad/3.png" mode="widthFix"></image>
				</view>
...
<script>
	import {apiAdMock} from '@/apis/index.js'
	export default {
		data() {
			return {
